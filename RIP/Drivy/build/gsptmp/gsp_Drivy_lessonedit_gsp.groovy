...
class gsp_Drivy_lessonedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/lesson/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'lesson.label', default: 'Lesson'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(this.lesson),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(this.lesson)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(this.lesson?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',32,['bean':("lesson")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',37,['resource':(this.lesson),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1439565095000L
