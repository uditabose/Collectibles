...
class gsp_Drivy_lessonindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/lesson/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(lessonList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(lessonCount ?: 0)],-1)
printHtmlPart(13)
})
