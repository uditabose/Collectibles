...
class gsp_Drivy_slotindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/slot/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(slotList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(slotCount ?: 0)],-1)
printHtmlPart(13)
})
