...
class gsp_Drivy_studentcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.student),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.student)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("student")],-1)
printHtmlPart(20)
