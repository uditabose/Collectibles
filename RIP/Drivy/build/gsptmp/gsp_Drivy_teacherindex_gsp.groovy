...
class gsp_Drivy_teacherindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/teacher/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(teacherList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(teacherCount ?: 0)],-1)
printHtmlPart(13)
})
